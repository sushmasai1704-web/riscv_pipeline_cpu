...
module simple_cpu(
    ...
    wire [31:0] rs1_fwd =
        ...
        (IF_ID_instr[19:15] != 5'b0 && IF_ID_instr[19:15] == WB_rd)  ? WB_data :
    ...
    wire [31:0] rs2_fwd =
        ...
        (IF_ID_instr[24:20] != 5'b0 && IF_ID_instr[24:20] == WB_rd)  ? WB_data :
    ...
    initial begin
        ...
        instr_mem[1] = 32'b00000000000000000000000000010011; // NOP
